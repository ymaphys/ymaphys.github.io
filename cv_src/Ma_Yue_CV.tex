...
实验核物理学家，日本理化学研究所（RIKEN）高级研究员（永久职位），在日本 J-PARC、SPring-8、KEK 与德国 GSI、DESY 等国际大型装置拥有二十年一线研究与领导经验，长期从事青年人才培养与国际合作网络建设。\keypt{现担任 \tech{J-PARC E73} 超氚核寿命 实验发言人，同时担任 \tech{SPring-8 LEPS2} 核子短程关联实验发言人与 \tech{J-PARC} 反氘核实验发言人}。

% ----------------------------------------------------------------------
\section{学术领导与学术任职}
\begin{itemize}
  \item \keypt{\tech{J-PARC E73} 超氚核寿命 实验发言人}——实验已完成取束，\hn{4}{H} 寿命与 \hn{3,4}{H} 产生截面已发表，\hn{3}{H} 寿命分析正在推进。
  \item \keypt{\tech{SPring-8 LEPS2} 核子短程关联 实验发言人}——以 $\Lambda$ 超子为探针研究原子核内部核子间短程关联（在研）。
  \item \keypt{\tech{J-PARC} 反氘核 实验发言人}——反氘核--原子核相互作用与湮灭机制（在研）。
\end{itemize}

\section{标志性研究成果}
\begin{enumerate}
  \item \keypt{\hn{4}{H} 超核寿命的精密测量}——作为发言人兼通讯作者，提出单 $\gamma$ 标定快速飞行 $\pi^0$ 的关键思想并主导测量，$\tau=206\pm8\pm12$\,ps（J-PARC E73）。\,{\small Phys.\ Lett.\ B \textbf{845} (2023); \textbf{873} (2026).}
  \item \keypt{\KN($I{=}1$) 阈附近 $\Lambda\pi$ 结构的首次观测}——作为第一作者主导 Belle 数据分析。\,{\small Phys.\ Rev.\ Lett.\ \textbf{130} (2023).}
  \item \keypt{\Kmpp（\KNN）反$K$介子--核束缚态的发现}——作为创始成员，研制多击 TDC 并以分波分析提取信号，给出国际上首个深束缚 \Kmpp 证据（J-PARC E15）。\,{\small Phys.\ Lett.\ B \textbf{789} (2019); Phys.\ Rev.\ C \textbf{102} (2020).}
  ...
  \item \keypt{能量分辨型缪子自旋谱学（$\mu$SR）的首次提出并实现}——作为第一作者兼通讯作者，将铅玻璃切伦科夫量能器用于逐事例正电子能量甄选并主导验证实验，在不增加束流时间的前提下将品质因数提升约 30\%（J-PARC MLF）。\,{\small Nucl.\ Instrum.\ Meth.\ A \textbf{1092}, 171842, Short communication (2026).}
  \item \keypt{硬双光子交换的判定（OLYMPUS）与 PbF$_2$ 亮度监测器}——负责亮度监测器研制，方案采用基于 M{\o}ller/Bhabha 散射的 PbF$_2$ 切伦科夫量能器，其精度为实验成败所系；OLYMPUS 判定硬双光子交换贡献显著弱于理论预期（DESY）。\,{\small Phys.\ Rev.\ Lett.\ \textbf{118} (2017); Nucl.\ Instrum.\ Meth.\ A \textbf{826} (2016).}
\end{enumerate}
...
\cvrow{2024--2028}{基盘研究（A）· 光子束测核内 $\rho$ 介子质量变化。研究分担者}
\cvrow{2023--2025}{RIKEN 奖励课题 · 探索物质--反物质相互作用。\textbf{负责人}}
\cvrow{2017--2020}{JSPS 若手研究（A）17H04842 · 解决超氚核寿命之谜。\textbf{负责人}}
\end{minipage}\hfill
...
\begin{minipage}[t]{0.52\linewidth}
\section{组织与管理 · 特邀报告}
\cvrow{2019--2021}{RIKEN 科研人员大会指导委员会委员；RIKEN 奖励课题物理学部协调人 / 总协调人}
...
\cvrow{语言}{中文（母语）· 英语（流利）· 日语（流利）}
\end{minipage}

% ----------------------------------------------------------------------
\section{代表性论文 \normalfont\small（Selected Publications，按标志性成果顺序排列；标注作者身份）}

{\small 发表论文 \keypt{120 余篇}（含 Belle / Belle\,II 合作组署名论文，见文末「合作组文章」一节）；下列为第一/通讯作者或起主导作用的代表性成果。}

{\small\color{impgray} 注：日本强子物理论文多按姓氏字母排序，下列标注\textbf{第一作者}/\textbf{通讯作者}/\textbf{发言人}者，为实际主导作用之明确标识。}

{\small
\begin{enumerate}\setlength{\itemsep}{2pt}
  \item T.~Akaishi \textit{et al.}, \textit{Precise lifetime measurement of $^{4}_{\Lambda}$H hypernucleus using in-flight $^{4}$He$(K^{-},\pi^{0})$ reaction}, Phys.\ Lett.\ B \textbf{845}, 138128 (2023). \role{发言人 \& 通讯作者}
  ...
  \item \textbf{Y.~Ma} \textit{et al.}, \textit{Demonstration of energy-resolved muon spin spectroscopy using a Cherenkov calorimeter}, Nucl.\ Instrum.\ Meth.\ A \textbf{1092}, 171842, Short communication (2026). \role{第一作者 \& 通讯作者}
  \item B.~S.~Henderson \textit{et al.}, \textit{Hard two-photon contribution to elastic lepton-proton scattering determined by the OLYMPUS experiment}, Phys.\ Rev.\ Lett.\ \textbf{118}, 092501 (2017). \role{主要贡献者之一；主导亮度监测器（PbF$_2$）研制}
  ...
  \item K.~Hosomi \textit{et al.}, \textit{Precise determination of $^{12}_{\Lambda}$C level structure by $\gamma$-ray spectroscopy}, Prog.\ Theor.\ Exp.\ Phys.\ \textbf{2015}, 081D01 (2015). \role{第二作者}
\end{enumerate}
}
