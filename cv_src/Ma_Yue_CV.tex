...
\begin{enumerate}
  ...
  \item \keypt{能量分辨型缪子自旋谱学（$\mu$SR）的首次提出并实现}——作为第一作者兼通讯作者，将铅化玻璃切伦科夫量能器用于逐事例正电子能量甄选并主导验证实验，在不增加束流时间的前提下将品质因数提升约 30\%（J-PARC MLF）。\,{\small Nucl.\ Instrum.\ Meth.\ A, in press (2026).}
...
\begin{enumerate}\setlength{\itemsep}{2pt}
  ...
  \item \textbf{Y.~Ma} \textit{et al.}, \textit{Demonstration of energy-resolved muon spin spectroscopy using a Cherenkov calorimeter}, Nucl.\ Instrum.\ Meth.\ A, in press (2026). \role{第一作者 \& 通讯作者}
