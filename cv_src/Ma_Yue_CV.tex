...
\begin{enumerate}
  ...
  \item \keypt{能量分辨缪子自旋谱学（$\mu$SR）的首次实现}——作为第一作者兼通讯作者，将铅玻璃切伦科夫量能器用于逐事例正电子能量甄选并主导验证实验，在不增加束流时间的前提下将品质因数提升约 30\%（J-PARC MLF）。\,{\small Nucl.\ Instrum.\ Meth.\ A, in press (2026).}
\end{enumerate}
