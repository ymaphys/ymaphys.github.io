...
\begin{enumerate}
  ...
  \item \keypt{エネルギー分解型ミュオンスピン分光（$\mu$SR）の世界初の提案と実証} —— 筆頭著者兼責任著者として、鉛ガラス・チェレンコフカロリメータによるイベント毎の陽電子エネルギー選別を導入して実証実験を主導、ビームタイムを増やすことなく性能指数を約 30\% 向上させた（J-PARC MLF）。\,{\small Nucl.\ Instrum.\ Meth.\ A, in press (2026).}
