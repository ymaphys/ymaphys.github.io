...
\begin{enumerate}
  ...
  \item \keypt{\hn{4}{H} 超核寿命の精密測定} —— スポークスパーソン兼責任著者として、高速 $\pi^0$ を単一の高エネルギー $\gamma$ で標識する鍵となるアイデアを提案し測定を主導、$\tau=206\pm8\pm12$\,ps（J-PARC E73）。\,{\small Phys.\ Lett.\ B \textbf{845} (2023).}
